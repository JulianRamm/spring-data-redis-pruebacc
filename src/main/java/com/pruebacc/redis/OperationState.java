...
public enum OperationState {
        ...
        ROULETTE_CLOSED("La ruleta se encuentra cerrada, no pueden recibir apuestas en estos momentos"),
        USER_ALREADY_ON_BET("El usuario ya realizó una apuesta sobre este número");
